...
func RandomSillyGreeting(userID string) string {
	...
	greetings := []string{
		...
		"<@%s> is [the eighth archangel. Gideon, the exalted.](https://www.thebiglead.com/posts/ranking-george-shea-s-hot-dog-eating-introductions-during-the-performance-of-a-lifetime-01g757b67f0f) Six-feet nine inches tall. Seven feet from tip of wing to tip of wing. The kale-eating champion of the world, now the schniff-finding champion!",
		...
		"<@%s> has [greater muscle mass than two football players and a Canadian](https://www.thebiglead.com/posts/ranking-george-shea-s-hot-dog-eating-introductions-during-the-performance-of-a-lifetime-01g757b67f0f) but the key to their success is schniffing speed. When they search, their hands are a blur!",
		"<@%s> operates from a platform of power and has [zero respect for indecision.](https://www.thebiglead.com/posts/ranking-george-shea-s-hot-dog-eating-introductions-during-the-performance-of-a-lifetime-01g757b67f0f) Impose your will on your campground search or have someone else impose their will on you!",
		"<@%s> lost the confidence of their co-workers when they mixed together all the food on their plate and said ['it's all going to the same place.'](https://www.thebiglead.com/posts/ranking-george-shea-s-hot-dog-eating-introductions-during-the-performance-of-a-lifetime-01g757b67f0f) Today they are universally acknowledged as the most efficient schniff-finder on the circuit!",
